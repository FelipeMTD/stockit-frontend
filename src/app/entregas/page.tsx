...
export default function HandoverPage() {
  ...
  // ✅ LIMPIADOR DE ENLACES: Forzamos la ruta siempre a Render
            ...
            <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[95vh] flex flex-col shadow-2xl overflow-hidden">
              ...
              <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4 sm:space-y-6">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 sm:p-5 space-y-4">
                  ...
                  {/* ✅ BOTONES DE DOCUMENTOS CORREGIDOS CON DOS OPCIONES (COMODATO Y SOPORTE) */}
                  <div className="mt-4 pt-4 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    
                    {/* Botón 1: El comodato siempre se puede deducir por el ID del handover */}
                    <a 
                    ...
                    {/* Botón 2: El soporte manual (factura) solo aparece si existe y no es el Comodato sobreescrito */}
