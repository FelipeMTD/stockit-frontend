...
// Asegura que siempre se vea un texto correcto y profesional
...
// Diseño Institucional sin colores morados
            ...
            return (
              <div key={r.id} className="bg-white border border-slate-200 rounded-xl p-5 flex justify-between items-center hover:shadow-md transition-all">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10px] text-slate-400 mt-1 font-medium">Programada: {fDateOnly(r.scheduledDate || r.date)}</p>
                </div>
